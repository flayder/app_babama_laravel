...
class PaymentMethodController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.payment_methods.index', $data);
    }

    public function sortPaymentMethods(Request $request, Gateway $gateway): void
    {
        $data = $request->all();
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.payment_methods.edit', $data);
    }
