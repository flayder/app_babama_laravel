...
namespace App\Services\Integrations\WebSmm;
...
/**
 * Сервис для работы с WebSmm
 */
class WebSmmService implements Seller
{
    ...
    {
        $apiName = config('services.sellers.list.web_smm.api_name');
        $client  = Http::$apiName();
    ...
    public function add(OrderDto $orderDto)
    {
        $dto = new SendSellerRequestDto([
            'action'   => config('services.sellers.list.web_smm.methods.add'),
            'key'      => $this->key,
    ...
    public function order(OrderDto $orderDto): OrderStatusSellerSuccessResponseDto|SellerFailedResponseDto
    {
        $dto = new OrderStatusSellerRequestDto([
            'action' => config('services.sellers.list.web_smm.methods.order'),
    ...
    public function orders(Collection|array $orders): Collection
    {
        ...
        $dto = new OrdersStatusSellerRequestDto([
            'action' => config('services.sellers.list.web_smm.methods.orders'),
    ...
    public function services(): Collection
    {
        $dto = new ServicesSellerRequestDto([
            'action' => config('services.sellers.list.web_smm.methods.services'),
            'key'    => $this->key
        ]);
