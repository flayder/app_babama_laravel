...
namespace App\Services\Integrations\PartnerSoc;
 ...
 */
class PartnerSocService implements Seller
{
    ...
    {
        $apiName = config('services.sellers.list.partner_soc.api_name');
    ...
    public function add(OrderDto $orderDto): SendSellerSuccessResponseDto|SellerFailedResponseDto
    {
        $dto = new SendSellerRequestDto([
            'action' => config('services.sellers.list.partner_soc.methods.add'),
            'key' => $this->key,
    ...
    public function order(OrderDto $orderDto): OrderStatusSellerSuccessResponseDto|SellerFailedResponseDto
    {
        $dto = new OrderStatusSellerRequestDto([
            'action' => config('services.sellers.list.partner_soc.methods.order'),
    ...
    public function orders(Collection|array $orders): Collection
    {
        ...
        $dto = new OrdersStatusSellerRequestDto([
            'action' => config('services.sellers.list.partner_soc.methods.orders'),
    ...
    public function services(): Collection
    {
        $dto = new ServicesSellerRequestDto([
            'action' => config('services.sellers.list.partner_soc.methods.services'),
            'key' => $this->key
        ]);
