...
if (false === \defined('CURL_SSLVERSION_TLSv1_1')) {
...
class Request
{
    ...
    public function setCurlSslOpts($curl): void
    {
    ...
    protected function processError($body, $httpStatusCode, $response): void
    {
    ...
    protected function throwServerError($body, $httpStatusCode): void
    {
    ...
    {
        $ua = 'Razorpay/v1 PHPSDK/'.Api::VERSION.' PHP/'.\PHP_VERSION;
    ...
    protected function getAppDetailsUa()
    {
        ...
        foreach ($appsDetails as $app) {
            if ((isset($app['title'])) && \is_string($app['title'])) {
                ...
                if ((isset($app['version'])) && \is_scalar($app['version'])) {
                    $appUa .= '/'.$app['version'];
                }
     ...
     */
    protected function verifyErrorFormat($body, $httpStatusCode): void
    {
