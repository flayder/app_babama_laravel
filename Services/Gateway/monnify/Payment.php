...
class Payment
{
    ...
    public static function ipn($request, $gateway, $order = null, $trx = null, $type = null)
    {
        ...
        if ($response->requestSuccessful && 'success' == $response->responseMessage) {
            if ($response->responseBody->amount == round($order->final_amount, 2) && $response->responseBody->currencyCode == $order->gateway_currency && 0 == $order->status) {
